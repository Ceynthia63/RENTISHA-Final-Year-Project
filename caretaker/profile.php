...
$apt   = $aptId ? getApartmentById($aptId) : null;
...
<head>
  ...
  <title>Profile — Rentisha Caretaker</title>
            ...
            <form action="../includes/upload_avatar.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="avatar-upload-area">
                ...
                <div class="avatar-actions">
                  <label class="btn btn-primary btn-sm" for="ctAvatarFile" aria-label="Upload photo">
                    <i class="bi bi-camera-fill"></i> Change Photo
                  </label>
                  <input type="file" id="ctAvatarFile" name="avatar" class="avatar-file-input"
                         accept="image/*" style="display:none;">
                  <button type="button" class="btn btn-outline btn-sm"
                    onclick="document.getElementById('ctAvatarPreview').innerHTML='<span style=\'font-size:2.5rem;font-weight:800;color:#007BFF\'><?= strtoupper(substr($_SESSION['name']??'C',0,1)) ?></span>'"
            ...
            <form action="../includes/update_profile.php" method="POST" data-validate>
              ...
              <div class="form-group">
                ...
                <input type="tel" name="phone" class="form-control"
                       ...
                       placeholder="07XX XXX XXX" pattern="(?:0[17][0-9]{8}|\+254[17][0-9]{8}|00254[17][0-9]{8})" maxlength="13" inputmode="tel" title="Enter a valid Kenyan phone number">
              </div>
              <div class="form-group">
                <label class="form-label">Role</label>
                <input type="text" class="form-control" value="Caretaker" readonly
                       style="background:var(--bg);cursor:not-allowed;">
              </div>
              <?php if ($apt): ?>
              <div class="form-group">
                <label class="form-label">Assigned Apartment</label>
                <input type="text" class="form-control"
                       value="<?= htmlspecialchars($apt['name'].' — '.$apt['location']) ?>"
                       readonly style="background:var(--bg);cursor:not-allowed;">
                <div class="form-hint">Assigned by Admin — cannot be changed here.</div>
              </div>
              <?php endif; ?>
        ...
        <div class="card-body">
          <form action="../includes/change_password.php" method="POST" data-validate style="max-width:520px;">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <i class="bi bi-lock-fill input-icon"></i>
                <input type="password" name="new_password" id="ctNewPwd" class="form-control"
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <i class="bi bi-lock-fill input-icon"></i>
                <input type="password" name="confirm_password" id="ctConfirmPwd" class="form-control"
                       required placeholder="Repeat new password">
              </div>
              <span class="form-error" id="ctPwdErr" style="display:none;">
...
<script>
document.getElementById('ctConfirmPwd')?.addEventListener('input', function() {
  document.getElementById('ctPwdErr').style.display =
    this.value === document.getElementById('ctNewPwd').value ? 'none' : 'flex';
});
</script>
</body>
</html>
